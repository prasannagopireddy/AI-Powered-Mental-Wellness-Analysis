...
├── 📄 evaluate.py                   # Model evaluation with full metrics report
├── 📄 predict.py                    # Single-text inference with confidence scores
│
├── 📁 processed_data/               # Auto-generated by preprocess.py (not tracked)
│   ├── processed_dataset.csv
│   ├── train.csv
│   ├── test.csv
│   └── label_map.json
│
├── 📁 final_model/                  # Saved model weights (not tracked — too large)
│
├── 📄 requirements.txt              # All Python dependencies
├── 📄 .gitignore                    # Excludes large files and generated folders
